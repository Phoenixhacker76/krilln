...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6584165626:AAGl-S7Q5jwkR_XOPAO8AtdOTVR0hQIwdBo")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Brook_probot") # Bot username without @.
